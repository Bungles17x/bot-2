...
3. Click **New +** > **Worker Service** (not Web Service)
...
7. Click **Deploy Worker Service**

### Manual Setup

1. Go to [Render Dashboard](https://dashboard.render.com/)
2. Click **New +** > **Worker Service** (not Web Service)
...
6. Click **Deploy Worker Service**

### Important Notes for Render

- **Use Worker Service, not Web Service** - Discord bots don't need HTTP endpoints
- The bot will run 24/7 on Render's free tier
- Worker services don't spin down like web services
- Monitor logs in the Render Dashboard to troubleshoot issues
- Free tier has 512MB RAM limit (sufficient for this bot)
